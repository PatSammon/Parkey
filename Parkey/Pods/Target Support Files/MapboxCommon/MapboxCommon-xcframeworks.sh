...
install_xcframework "${PODS_ROOT}/MapboxCommon/MapboxCommon.xcframework" "MapboxCommon" "framework" "ios-arm64_armv7" "ios-x86_64-maccatalyst" "ios-arm64_i386_x86_64-simulator"
